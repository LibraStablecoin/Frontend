...
export default function Mint() {
  ...
  } = useMinterCallback(libraCurrency, usdcCurrency, libraAmount, usdcAmount)
  ...
  function getApproveButton(): JSX.Element | null {
    ...
    if (showApprove) {
      return <RedeemButton onClick={handleApprove}>Allow us to spend {usdcCurrency?.symbol}</RedeemButton>
    }
    return null
  }
  ...
  function getActionButton(): JSX.Element | null {
    ...
    if (insufficientBalance) {
      return <RedeemButton disabled>Insufficient {usdcCurrency?.symbol} Balance</RedeemButton>
    }
